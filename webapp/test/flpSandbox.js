		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind UI5",
									"targetURL": "#northwindodataui5northwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindodataui5northwind-display": {
								"semanticObject": "northwindodataui5northwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwind.odata.ui5.northwind",
									"url": sap.ui.require.toUrl("northwind/odata/ui5/northwind")
								}
							}
						}
					}
